package com.example.hppybirthdaycard
...
import com.example.hppybirthdaycard.ui.theme.HppyBirthDayCardTheme
        ...
        setContent {
            HppyBirthDayCardTheme {
                Surface(
                    ...
                    GreetText(message="Happy BirthDay",from="from haruki")
                }
            }
        }
    }
...
@Composable
fun GreetText(message: String,from: String, modifier: Modifier = Modifier){
